...
def run(dataset_dir, code_dir):
    ...
    starting_kit_dir = '/mnt/d/code/RL/djssp'
...
def _parse_args():
    default_starting_kit_dir = '/mnt/d/code/RL/djssp'
    default_code_dir = join(default_starting_kit_dir, 'rule_based')

    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset_dir', type=str,
                        default='/mnt/d/code/RL/djssp/data/public/01',
