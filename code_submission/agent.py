...
class Agent:
    ...
    def ptfirst(self, agent_id):
        ...
        if len(candi_list) == 0:
            ...
            a = sorted(candi_list, key=lambda x: (self.job_status[x]['remain_process_time']/(abs(self.job_status[x]['remain_pending_time'])+1), self.job_status[x]['remain_pending_time']))[0]
            return a
